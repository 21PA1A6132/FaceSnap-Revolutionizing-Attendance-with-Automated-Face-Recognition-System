...
with open('FaceEmbeddings.pickle', "wb") as f:
    pickle.dump(data,f)
...
with open(f'recognizer_5.pickle', "wb") as f:
    f.write(pickle.dumps(recognizer))

with open(f"le_5.pickle", "wb") as f:
    f.write(pickle.dumps(le))

print("Epoch 5 embeddings loaded succesfullly")
