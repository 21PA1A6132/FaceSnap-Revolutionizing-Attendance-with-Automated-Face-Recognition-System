...
with open("pickle\FaceEmbeddings.pickle", 'rb') as f:
...
for epoch in range(5,10):
    ...
    with open(f'FaceEmbeddings {epoch+1}.pickle', "wb") as f:
        pickle.dump(data, f)
    ...
    with open(f'recognizer {epoch+1}.pickle', "wb") as f:
        f.write(pickle.dumps(recognizer))

    with open(f"le {epoch+1}.pickle", "wb") as f:
